		...
		return (
			<Row>
				<Col xs={12}>
					...
					<h4 className='alignCenter'><a className='fontMainColorLight' target="_blank" href={googleMapsUrl}>Click <h4 className='fontAccentColor displayInline'>here</h4> for directions</a></h4>
				</Col>
				<Col xs={12}>
