		...
		<Row className=''>
			...
			<Row>
				<Col xs={12} className='noPaddingLeft noPaddingRight'>
					...
					<p> You can create a trip via the Build Trip page (rememeber to enter a time and trip name), and invite your friends on it. They will automatically be sent an email with a link to the trip page. At any point, you can go to a trip's page to see the current state of the trip. Initially, the people coming on a trip can RSVP and mark the locations they will be travelling from. Once everyone has reponded, (or if the trip owner decides they're taking too long and clicks 'proceed to voting', Coordin-EAT will calculate an optimal meeting location, and suggest five restaurants near it. Everyone one on the trip can vote on which to go to, and when all the votes are in, the trip page will switch to showing a map and a link to directions.</p>
